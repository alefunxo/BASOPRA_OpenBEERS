   ...
   'Price_DT_mod']
    ...
    if (conf!=0)&(conf!=1)&(conf!=4)&(conf!=5):#TS present
        ...
        if (combinations['house_type']=='SFH15')|(combinations['house_type']=='SFH45'):
            ...
            tank_sh=pc.heat_storage_tank(mass=3000,surface=18.85) # For a 1500 liter tank with 1.426 m height and 1.25 diameter 
            T_min_cooling=285.15#12°C
    else:#No TS
