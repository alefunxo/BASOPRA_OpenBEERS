    ...
    def __init__(self,Capacity,choicetype,**kwargs):
        ...
        try:
            if choicetype=='NMC':#Tesla
                ...
                'SOC_max': 1*Capacity,
                'SOC_min': 0*Capacity,
                'Price_battery': 410*Capacity,
                'Battery_cal_life': 15,
                'Battery_cycle_life': 5000,
                'PCS_costs': 441*EUR_USD,
                'BOS_costs':2187*EUR_USD,
                'OandM_costs': 0,
                'Fix_costs': 0,
                'EoL': 0.7,
				'IRENA_future_Price':167*Capacity}
...
###############################################################################
                ...
                'SOC_max': 1*Capacity,
                'SOC_min': 0*Capacity,
                'Price_battery': 650*Capacity,
                'Battery_cal_life': 20,
                'Battery_cycle_life': 8000,
                'PCS_costs': 286.65*EUR_USD,
                'BOS_costs':2241*EUR_USD,
                'OandM_costs': 0,
                'Fix_costs': 0,
                'EoL': 0.7,
				'IRENA_future_Price':145*Capacity}
                for key, val in defaults.items():
                    setattr(self, key, val)
                self.__dict__.update(kwargs)
###############################################################################
...
###############################################################################
                ...
                'BOS_costs':2061*EUR_USD,
                'OandM_costs': 0,
                'Fix_costs': 0,
                'EoL': 0.7,
				'IRENA_future_Price':224*Capacity}
...
###############################################################################
                ...
                'BOS_costs':1622*EUR_USD,
                'OandM_costs': 0,
                'Fix_costs': 0,
                'EoL': 0.7,
				'IRENA_future_Price':480*Capacity}
                for key, val in defaults.items():
                    setattr(self, key, val)
                self.__dict__.update(kwargs)
###############################################################################
...
###############################################################################
                ...
                'Price_battery': 750*Capacity,
                'Battery_cal_life': 15,
                'Battery_cycle_life': 4500,
                'PCS_costs': 766,
                'BOS_costs':2030*EUR_USD,
                'OandM_costs': 22*EUR_USD,
                'Fix_costs': 0,
                'EoL': 0.7,
				'IRENA_future_Price':330*Capacity}
                for key, val in defaults.items():
                    setattr(self, key, val)
                self.__dict__.update(kwargs)
###############################################################################
...
###############################################################################
                ...
                'Price_battery': 330*Capacity,
                'Battery_cal_life': 10,
                'Battery_cycle_life': 1500,
                'PCS_costs': 466*EUR_USD,
                'BOS_costs':1143*EUR_USD,
                'OandM_costs': 0,
                'Fix_costs': 0,
                'EoL': 0.7,
				'IRENA_future_Price':150*Capacity}
                for key, val in defaults.items():
                    setattr(self, key, val)
                self.__dict__.update(kwargs)
